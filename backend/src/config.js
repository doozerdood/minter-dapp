...
const description = "Members of the GALACTIC ELITE, who hold all the keys to luxury in the galaxy.";
...
const ROYALTY_SHARE = 1250; // Percentage of the token price that goes to the royalty address. 100 bps = 1%
...
const PRESALE_WHITELISTED_ADDRESSES = ["0xb3368a88572971766fc2a6658514b6c4A1168d38"]; // only update if you want to manually set the whitelisted addresses
// ** OPTIONAL **
